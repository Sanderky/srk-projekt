...
interface ReservationDataProps {
	...
	createReservation: (email: string | undefined, doctorId: string | undefined, date: Date | undefined, time: string | undefined) => void;
}
	...
	return (
		<div className={styles.dataSummary}>
			...
			<div className={styles.summaryData}>
				...
				<button className={styles.clearSelections} onClick={(event) => clearSelections(event)}>
					Wyczyść wybory
				</button>
			</div>
		</div>
	...
	return (
		<form className={styles.emailForm}>
			<div className={styles.formPart}>
				...
				<input
					className={checkEmailValidity() ? `${styles.wrongEmailInput} ${styles.emailInput}` : styles.emailInput}
					type="text"
					id="email"
					name="email"
					ref={email}
			...
			<div className={styles.formPart}>
				...
				<input
					className={checkEmails() ? `${styles.wrongEmailInput} ${styles.emailInput}` : styles.emailInput}
					type="text"
					id="confirmEmail"
					name="confirmEmail"
					ref={confirmEmail}
			...
			<button
				className={ifButtonActive() ? styles.createReservationButton : styles.createReservationButtonInactive}
				type="button"
				onClick={(event) => createReservation(email.current?.value, doctorId, date, time)}
